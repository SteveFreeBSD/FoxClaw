...
| M-6 | Medium | Consolidate duplicated constants/helpers | Pending (WS-62) |
| L-1 | Low | Decide on `--keep-stage-writeable` spelling | Pending (WS-63) |
| L-2 | Low | Fix misleading symlink error message in `policies.py` | Pending (WS-63) |
| L-3 | Low | Promote private trust functions to public API | Pending (WS-63) |
